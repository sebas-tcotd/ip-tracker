...
export const TrackingHeader = () => {
  return (
    <header className="p-6 | relative | flex flex-col items-center gap-4 flex-grow-[25] sm:flex-grow-[175] md:flex-grow-[70] | bg-mobile-header-texture md:bg-desktop-header-texture bg-cover">
